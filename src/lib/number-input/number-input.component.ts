...
export class NumberInputComponent implements OnInit, OnChanges {
  ...
  ngOnInit(): void {
    if (
      ...
      this.columnConfig?.control?.range
    ) {
      const rangeValues =
        this.form?.controls[this.columnConfig?.control?.name]?.value.split(',');
  ...
  ngModelChange() {
    if (
      this.numberRangeValuesForm.controls['to'].value != null &&
      ...
      this.form.controls[this.columnConfig?.control?.name].setErrors({
      ...
      if (
        (this.numberRangeValuesForm.controls['from'].value === '' ||
          this.numberRangeValuesForm.controls['from'].value == null) &&
        (this.numberRangeValuesForm.controls['to'].value === '' ||
          this.numberRangeValuesForm.controls['to'].value == null)
      ) {
        this.form.controls[this.columnConfig?.control?.name].setValue(null);
        ...
        this.form.controls[this.columnConfig?.control?.name].setValue(
          `${
            this.numberRangeValuesForm.controls['from'].value != null ||
            this.numberRangeValuesForm.controls['from'].value === 0
              ? this.numberRangeValuesForm.controls['from'].value
              : ''
          },${
            this.numberRangeValuesForm.controls['to'].value !== null ||
            this.numberRangeValuesForm.controls['to'].value === 0
              ? this.numberRangeValuesForm.controls['to'].value
              : ''
          }`
        );
